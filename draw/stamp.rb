...
Stamp::CurveIcon = Stamp.new([
  Stamp::Stroke.circle(0.1,0.4,0.06),
  Stamp::Stroke.circle(0.5,0.5,0.06),
  Stamp::Stroke.circle(0.9,0.6,0.06),
  [[0.1,0.4],[0.35, 0.3],[0.5, 0.5],[0.65, 0.7],[0.9, 0.6]]
])
Stamp::EraserIcon = Stamp.new([
  [[0.2,0.6],[0.6,0.7]],
  [[0.6,0.7],[0.8,0.2]],
  [[0.8,0.2],[0.4,0.1]],
  [[0.4,0.1],[0.2,0.6]],
  [[0.2,0.6],[0.2,0.8],[0.4,0.9],[0.6,0.7]]
])
